...
function mapRefereeCheck(c: ApiRefereeCheck): RefereeParticipantCheck {
  return {
    ...
    horseRegistrationId: c.horseRegistrationId ?? undefined,
    horseBreed: c.horseBreed,
    horseSire: c.horseSire ?? undefined,
    horseDam: c.horseDam ?? undefined,
    horseTrainerName: c.horseTrainerName ?? undefined,
    horseAge: c.horseAge,
    horseColor: c.horseColor ?? undefined,
    horseWeight: c.horseWeight ?? undefined,
    horseHealth: c.horseHealthStatus ? HEALTH[c.horseHealthStatus] ?? c.horseHealthStatus : undefined,
    horseImageUrl: c.horseImageUrl ?? undefined,
    horseProfilePdfUrl: c.horseProfilePdfUrl ?? undefined,
    horseProfilePdfName: c.horseProfilePdfName ?? undefined,
    jockeyId: c.jockeyId,
